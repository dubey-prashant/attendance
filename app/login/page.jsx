    ...
    <div className=" flex justify-center h-full items-center ">
      <form className='max-w-sm w-full rounded bg-popover shadow-xl p-6'>
        ...
        <div className="mb-6">
          ...
          <input type="email" id="email" className="bg-input border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-popover-foreground dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@flowbite.com" required />
        </div>
        <div className="mb-6">
