...
function Options({ onDelete }) {
  return (
    ...
    <button 
      ...
      <PopoverContent align="right" noStyles >
        <div
          className="text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700"
        >
...
export default function ClassCard({id, name, description , image, onDelete }) {
  return (
